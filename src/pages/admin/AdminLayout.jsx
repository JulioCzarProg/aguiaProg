...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-slate-900">
      ...
      {/* Sidebar — fixa em tela cheia (desktop): nav rola, "Sair" sempre visível */}
      <aside className={`fixed lg:sticky lg:top-0 z-40 inset-y-0 left-0 w-64 h-screen flex flex-col bg-white dark:bg-slate-800 border-r dark:border-slate-700
        transform transition-transform lg:translate-x-0 ${aberto ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="h-16 shrink-0 flex items-center gap-2 px-5 border-b dark:border-slate-700">
        ...
        <div className="shrink-0 p-3 border-t dark:border-slate-700">
